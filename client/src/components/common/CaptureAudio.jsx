...
function CaptureAudio({hide}) {
  ...
  return (
    <div className="flex text-2xl w-full justify-end items-center">
      ...
      <div className="mx-4 py-2 text-white px-4 text-lg flex gap-3 justify-center items-center bg-search-input-container-background rounded-full drop-shadow-lg">
        {isRecording ? (
      ...
      <div className="mr-4">
        {!isRecording ? <FaMicrophone className="text-red-500" onClick={handleStartRecording}/> : <FaPause className="text-red-500" onClick={handleStopRecording}/>}
      </div>
      <div>
        <MdSend className="mr-4 text-panel-header-icon cursor-pointer" title="Send" onClick={sendRecording}/>
      </div>
    </div>
  )
}
